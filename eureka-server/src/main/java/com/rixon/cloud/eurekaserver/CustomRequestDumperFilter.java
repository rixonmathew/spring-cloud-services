...
public class CustomRequestDumperFilter extends GenericFilter {
    ...
    private static final ThreadLocal<CustomRequestDumperFilter.Timestamp> timestamp = ThreadLocal.withInitial(CustomRequestDumperFilter.Timestamp::new);

    // Log must be non-static as loggers are created per class-loader and this
    // Filter may be used in multiple class loaders
    private transient Logger log = LoggerFactory.getLogger(CustomRequestDumperFilter.class);
    ...
    private String getTimestamp() {
        CustomRequestDumperFilter.Timestamp ts = timestamp.get();
    ...
    private void readObject(ObjectInputStream ois) throws ClassNotFoundException, IOException {
        ...
        log = LoggerFactory.getLogger(CustomRequestDumperFilter.class);
    }
